...
describe("BackgroundMask integration", () => {
    ...
    it("BackgroundMask with both element and draw works", () => {
        const mask = new BackgroundMask(), canvas = document.createElement("canvas");
        mask.load({
            enable: true,
            cover: {
                element: canvas,
    ...
    it("BackgroundMaskCover element accepts direct HTMLCanvasElement reference", () => {
        const cover = new BackgroundMaskCover(), canvas = document.createElement("canvas");
