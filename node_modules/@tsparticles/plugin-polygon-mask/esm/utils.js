import { Vector, double, getDistances, getStyleFromRgb, rangeColorToRgb, squareExp, } from "@tsparticles/engine";
const inSegmentRange = {
    min: 0,
    max: 1,
};
export function drawPolygonMask(pluginManager, context, rawData, stroke, hdr = false) {
...
export function drawPolygonMaskPath(pluginManager, context, path, stroke, position, hdr = false) {
