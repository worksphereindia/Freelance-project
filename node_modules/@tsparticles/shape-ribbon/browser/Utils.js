import { AlterType, Vector, alterHsl, getHslFromAnimation, getRandom, getRangeValue, getStyleFromHsl, } from "@tsparticles/engine";
...
export function setRibbonBounds(particle, width, height) {
...
export function createRibbonState(particle) {
...
export function updateRibbon(data) {
...
export function drawRibbon(data, hdr) {
