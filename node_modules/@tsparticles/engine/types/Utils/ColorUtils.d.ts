...
export declare function hslToRgbFloat(hsl: IHsl): IRgb;
export declare function hslaToRgba(hsla: IHsla): IRgba;
export declare function getRandomRgbColor(min?: number, hdr?: boolean): IRgb;
export declare function getStyleFromRgb(color: IRgb, hdr: boolean, opacity?: number): string;
...
export declare function updateColorValue(data: IParticleColorAnimation, decrease: boolean, delta: IDelta, hdr?: boolean): void;
export declare function updateColor(color: IParticleHslAnimation | undefined, delta: IDelta, hdr?: boolean): void;
